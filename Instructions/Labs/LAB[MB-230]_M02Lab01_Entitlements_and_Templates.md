...
4.  Enter **[your prefix ex. mollyc]** + **Audio System Setup Issues** for **Case Title**, select the **Relecloud** account you created in the earlier lab for **Customer**, select **Email** for **Origin**, select **Problem** for **Type** and click **Save & Close**. The entitlement should be applied automatically.
